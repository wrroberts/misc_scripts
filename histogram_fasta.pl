#!/usr/bin/perl -w
# histogram_fasta.pl
# AUTHOR: Wade R. Roberts
# This program calculates and outputs the following information for a de novo transcriptome assembly.
# 	1. Histogram intervals of contig sizes
